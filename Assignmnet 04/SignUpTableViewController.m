...
- (BOOL)textFieldShouldReturn:(UITextField *)textField{
    ...
    if (textField == Signup_Username){
        [textField resignFirstResponder];
        textField = Signup_email;
        [textField becomeFirstResponder];
    }
    else if (textField == Signup_email){
        [textField resignFirstResponder];
        textField = Signup_FPass;
        [textField becomeFirstResponder];
    }
    else if (textField == Signup_FPass){
        [textField resignFirstResponder];
        textField = Signup_SPass;
        [textField becomeFirstResponder];
        
    }
    else if (textField == Signup_SPass){
        [textField resignFirstResponder];
